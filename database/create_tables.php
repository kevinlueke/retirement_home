...
$queryUsers ="CREATE TABLE Users(id bigint PRIMARY KEY AUTO_INCREMENT, role_id bigint REFERENCES Roles (id), first_name varchar(20) NOT NULL, last_name varchar(20) NOT NULL, email varchar(50) NOT NULL, phone varchar(15) NOT NULL,password varchar(255) NOT NULL, date_of_birth date, approved boolean NOT NULL);";
...
$queryReceipt ="CREATE TABLE Receipt (id bigint PRIMARY KEY AUTO_INCREMENT, amount_paid bigint DEFAULT 0, user_id bigint REFERENCES Users (id), date_paid date );"; 
...
$queryRoster ="CREATE TABLE Roster (id bigint PRIMARY KEY AUTO_INCREMENT, roster_date date NOT NULL, supervisor_id bigint REFERENCES Employees (employee_id) , doctor_id bigint REFERENCES Employees (employee_id) , caregiver_1 bigint REFERENCES Employees (employee_id) , caregiver_2 bigint REFERENCES Employees (employee_id) , caregiver_3 bigint REFERENCES Employees (employee_id) , caregiver_4 bigint REFERENCES Employees (employee_id) , group_1 bigint REFERENCES `Group` (id), group_2 bigint REFERENCES `Group` (id), group_3 bigint REFERENCES `Group` (id), group_4 bigint REFERENCES `Group` (id));";
